...
public class Pet {
  // As discussed in the previous lesson, encapsulation is the concept of of
  // bundling data and methods that work on that data within one unit.
  // Encapsulation also is used to hide the internal representation, or state of
  // an object from the outside. This is called information hiding.
  // In order to do this, we add the access modifier keyword "private" to the
  // attributes and add public accessor and mutator methods (getter and setters)
  ...
  // The public keyword is an access modifier that allows access from other
  // classes.
